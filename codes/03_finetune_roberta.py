...
MODEL_ARCH = "roberta"
OUTPUT_DIR = MODELS_DIR / "tlink_roberta_final"
CHECKPOINT_DIR = MODELS_DIR / "tlink_roberta_checkpoints"
SEED = 42
MAX_LENGTH = 256
...
def main() -> None:
    ...
    tokenized = tokenized.remove_columns(
        [column for column in tokenized["train"].column_names if column not in {"input_ids", "attention_mask", "labels"}]
    )
