...
# This intercepts the broken command and removes 'truncate_words_to' before it crashes
...
attack_args = textattack.AttackArgs(
    num_examples=200, 
    log_to_csv="./results/bert_a2t_results.csv",
...
print("Starting A2T Attack on BERT...")
attacker.attack_dataset()
print("✅ Attack finished. Results saved to ./results/bert_a2t_results.csv")