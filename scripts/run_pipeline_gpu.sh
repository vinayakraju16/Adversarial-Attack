...
require_file "${REPO_ROOT}/codes/02_finetune_bert.py"
require_file "${REPO_ROOT}/codes/03_finetune_roberta.py"
require_file "${REPO_ROOT}/run.py"
...
# echo "[INFO] Running BERT fine-tuning"
# python codes/02_finetune_bert.py
# echo "[INFO] Running RoBERTa fine-tuning"
# python codes/03_finetune_roberta.py

echo "[INFO] Running attacks"
python run.py
